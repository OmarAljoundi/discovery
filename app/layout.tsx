...
const CustomerClientProvider = ImportDynamic(() => import('@/provider/customer-client-provider').then((mod) => mod.default), {
  ssr: false,
})
const SettingLayoutProvider = ImportDynamic(() => import('@/provider/setting-layout-provider').then((mod) => mod.default), {
  ssr: false,
})

...
const CardDetails: FunctionComponent<Location> = ({ name, created_at, slug, id, image, is_active, seo, location_attributes }) => {
          ...
          <div className="flex gap-1 justify-between items-center w-full pt-3 pb-1 px-4">
            <div className="flex">
              <Button
                ...
                radius="full"
                variant="light"
                onPress={() => modal.onOpenDestination({ name, created_at, id, image, is_active, seo, slug })}
              >
                <Edit />
              </Button>
              <Button
            ...
            <Button
              ...
              variant="shadow"
              color="primary"
              onPress={() => modal.onOpenDestinationTours({ name, created_at, id, image, is_active, seo, location_attributes, slug })}
            >
              Assign to tours
            </Button>
          </div>

...
const SubSidebarNav: FunctionComponent<SubSidebarNavProps> = () => {
  ...
  return (
    <div className="h-screen fixed w-[200px]  transition-all  hide-scrollbar  border-r bg-scale-200 dark:border-dark ">
      <div className="dark:border-dark flex max-h-12 items-center border-b px-6" style={{ minHeight: '3rem' }}></div>
                ...
                <div className="space-y-3">
                  {MenuItems?.map((item) => (
                    <Link
                      ...
                      aria-current="page"
                    >
                      <div className={cn(`transition-colors w-full duration-200 flex items-center justify-start gap-x-2 group h-9 rounded`)}>

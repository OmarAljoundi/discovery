...
import { Button, Checkbox, CheckboxGroup, Chip, Input, User } from '@nextui-org/react'
                    ...
                    >
                      <div className="w-full flex justify-between gap-2">
                        <User
                          avatarProps={{
                            size: 'sm',
                            src: tour.images && tour.images.length > 0 ? `${process.env.NEXT_PUBLIC_IMAGE_URL}${tour.images[0]}` : '',
                          }}
                          name={tour.name}
                        />
                      </div>
